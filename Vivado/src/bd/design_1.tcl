...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net axi_iic_1_IIC [get_bd_intf_ports iic_rtl_0] [get_bd_intf_pins axi_iic_1/IIC]
  ...
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M01_AXI [get_bd_intf_pins axi_serdes_fmc_0/S00_AXI] [get_bd_intf_pins processing_system7_0_axi_periph/M01_AXI]
  ...
  connect_bd_net -net axi_serdes_fmc_0_trx0_clk_bufg_div_o [get_bd_pins axi_serdes_fmc_0/m00_axis_aclk] [get_bd_pins axi_serdes_fmc_0/s00_axis_aclk] [get_bd_pins axi_serdes_fmc_0/trx0_clk_bufg_div_o]
  connect_bd_net -net axi_serdes_fmc_0_trx0_clk_bufr_o [get_bd_pins axi_serdes_fmc_0/trx0_clk_bufr_o] [get_bd_pins axi_serdes_fmc_0/trx0_clk_i]
  ...
  connect_bd_net -net axi_serdes_fmc_0_trx1_clk_bufg_div_o [get_bd_pins axi_serdes_fmc_0/m01_axis_aclk] [get_bd_pins axi_serdes_fmc_0/s01_axis_aclk] [get_bd_pins axi_serdes_fmc_0/trx1_clk_bufg_div_o]
  connect_bd_net -net axi_serdes_fmc_0_trx1_clk_bufr_o [get_bd_pins axi_serdes_fmc_0/trx1_clk_bufr_o] [get_bd_pins axi_serdes_fmc_0/trx1_clk_i]
